...
fn block() {
    let bl = Block{
        shards: vec![
            BlockShard{file: String::from("tests/fixtures/a"), offset: 0, size:4},
            BlockShard{file: String::from("tests/fixtures/b"), offset: 0, size:4},
        ]
    };
    let mut content = String::new();
